    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white px-4 py-4 border-b border-gray-100">
        <div className="flex items-center justify-around">
          <div className="text-center">
            <div className="flex items-center justify-center gap-1">{renderStars(farmer.rating)}</div>
            <p className="text-gray-500 text-xs mt-1">{farmer.rating.toFixed(1)} ({farmer.reviewCount} avis)</p>
          </div>
          <div className="text-center">
